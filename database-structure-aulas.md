...
> **Last update**: 2026-07-14 16:28:45
> **Base**: aulas (Aulas)
...
| **ActivoSoftr**<br>`fld0xpYTUyFcFPSUA` | `checkbox` | True/False checkbox |  |
...
| **UserRol**<br>`fldXwWKaAn9JQuaFp` | `singleSelect` | Single choice dropdown | `Rector`, `Directivo nivel 2`, `Gestión` |
...
| **ColegiosAcceso**<br>`fld2eH4HfuRICy8yY` | `multipleRecordLinks` | Type: multipleRecordLinks |  |
| **AuthVersion**<br>`fldyBF6Wb08SEo9e2` | `number` | Numeric field |  |
...
| **UsuariosWeb**<br>`fldUfgGpusv8bZsGf` | `multipleRecordLinks` | Type: multipleRecordLinks |  |
...
| **Anno_tag**<br>`fldhptrmqtZ3p3D5T` | `multipleLookupValues` | Type: multipleLookupValues |  |
...
**Last sync**: 2026-07-14 16:28:45

---
*Documentation for Aulas base - Generated 2026-07-14 16:28:45*