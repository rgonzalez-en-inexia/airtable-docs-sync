...
> **Last update**: 2026-06-13 10:34:16
...
## 📋 20. InstitutionStudentValidation
...
## 📋 46. AI_Modelos_Reporte_Semanal

*Table ID: `tblXPVwb3bxs0wZ1N`*
*Fields: 6*

| Field | Type | Description | Options |
|-------|------|-------------|---------|
| **Name**<br>`fldI6xDioJvBu65G1` | `singleLineText` | Type: singleLineText |  |
| **Fecha**<br>`fldVstBKiGTcH7rxm` | `date` | Date |  |
| **Ambiente**<br>`fldBZ49UtMjq1ghcy` | `singleSelect` | Single choice dropdown | `PROD`, `DEV`, `AMBOS` |
| **ResumenPrompt**<br>`fldPRjjm6rSx48VYh` | `multilineText` | Multi-line text |  |
| **JSONParametros**<br>`flduazvsYSe1F93nM` | `multilineText` | Multi-line text |  |
| **CantidadParametros**<br>`fldT2fi7VidiEEAdW` | `number` | Numeric field |  |
...
**Last sync**: 2026-06-13 10:34:16

---
*Documentation for Default base - Generated 2026-06-13 10:34:16*